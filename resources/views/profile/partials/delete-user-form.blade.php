<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __("Quando il tuo account viene cancellato, tutti i dati relativi saranno
            permanemente eliminati. Per favore inserisci la tua password per confermare l'eliminazione del tuo account.") }}
        </p>
    </header>
