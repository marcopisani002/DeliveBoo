...
<div class="container">
    ...
    @method('put')
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('cover_img') is-invalid @enderror"
            name="cover_img" value="{{ old('cover_img', $restaurant->cover_img) }}">
            @error('cover_img')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
            ...
            <img src="{{ asset('storage/' . $restaurant->cover_img) }}" alt="" class="img-thumbnail">
        </div>
        ...
        <div class="mb-3">
            ...
            <input class="form-check-input @error('types') is-invalid @enderror" type="checkbox"
                id="CheckType_{{ $loop->index }}" value="{{ $type->id }}" name="types[]"
